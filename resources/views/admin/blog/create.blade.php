...
<div class="bg-white shadow rounded-lg p-6">
    <h2 class="text-xl font-semibold text-gray-800 mb-6">Crear Nuevo Artículo</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <div class="mb-4">
                    ...
                    <p class="mt-1 text-sm text-gray-500">Dejar en blanco para generar automáticamente</p>
                </div>
                
                <div class="mb-4">
                    <label for="excerpt" class="block text-sm font-medium text-gray-700">Resumen *</label>
                    <textarea name="excerpt" id="excerpt" rows="3" 
                              class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50" required>{{ old('excerpt') }}</textarea>
                ...
                <div class="mb-4">
                    ...
                    <textarea name="content" id="content" rows="10" 
                              class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50 editor" required>{{ old('content') }}</textarea>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="tags" id="tags" value="{{ old('tags') }}" 
                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                    <p class="mt-1 text-sm text-gray-500">Separadas por comas (ej: salud visual, lentes, oftalmología)</p>
                </div>
                
                <div class="mb-4">
                    <label for="author" class="block text-sm font-medium text-gray-700">Autor *</label>
                    <input type="text" name="author" id="author" value="{{ old('author', 'GRC Clínica Optométrica') }}" 
                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50" required>
                </div>
                ...
                <div class="mb-4">
                    <div class="flex items-center">
                        ...
                        <label for="is_published" class="ml-2 text-sm text-gray-700">Publicar ahora</label>
                    </div>
                </div>
                ...
                <div class="border-t border-gray-200 pt-4 mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="meta_description" id="meta_description" rows="3" 
                                  class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50">{{ old('meta_description') }}</textarea>
