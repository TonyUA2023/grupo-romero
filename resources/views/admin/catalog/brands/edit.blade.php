    ...
    <div class="bg-white shadow rounded-lg">
        ...
        <div class="px-6 py-4 border-b border-gray-200">
            <div class="flex items-center justify-between">
                <h2 class="text-2xl font-semibold text-gray-800">Editar Marca</h2>
        ...
        <!-- Form -->
        <form action="{{ route('admin.catalog.brands.update', $brand) }}" method="POST" enctype="multipart/form-data" class="p-6">
            @csrf
            @method('PUT')
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea name="description" 
                                      ...
                                      placeholder="Describe la marca, su historia, valores, etc.">{{ old('description', $brand->description) }}</textarea>
                            @error('description')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                ...
                <div class="bg-gray-50 rounded-lg p-6">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-500">
                            Selecciona un nuevo logo para reemplazar el actual. Formatos: JPG, PNG, GIF, SVG. Máximo: 2MB
                        </p>
                        
                        <!-- Logo Preview -->
                        <div id="logoPreview" class="mt-4 hidden">
                            <p class="text-sm text-gray-700 mb-2">Nuevo logo:</p>
                            <div class="bg-gray-100 rounded-lg p-4 inline-block">
                        ...
                        @if($brand->products->count() > 0)
                            <div class="bg-blue-50 border border-blue-200 rounded-lg p-3">
                                <p class="text-sm text-blue-800">
                                    ...
                                    Esta marca tiene {{ $brand->products->count() }} productos asociados.
                                    @if(!$brand->is_active)
                                        Desactivar la marca no afectará la visibilidad de los productos.
                                    @endif
                                </p>
                            </div>
                        @endif
                        ...
                        @if($brand->is_featured)
                            <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                                ...
                                <p class="text-sm text-yellow-700">
                                    Esta marca aparece en secciones destacadas del sitio. 
                                    Desmarcar esta opción la removerá de dichas secciones.
                                </p>
                            </div>
                        @endif
                    </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea name="meta_description" 
                                      id="meta_description" 
                                      rows="3"
                                      class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('meta_description') border-red-500 @enderror">{{ old('meta_description', $brand->meta_description) }}</textarea>
