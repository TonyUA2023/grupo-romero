...
<div class="max-w-6xl mx-auto">
    <div class="bg-white shadow rounded-lg">
        ...
        <!-- Form -->
        <form action="{{ route('admin.catalog.products.store') }}" method="POST" enctype="multipart/form-data" class="p-6">
            @csrf
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                <label for="video" class="block text-sm font-medium text-gray-700 mb-1">
                                    Video (YouTube o URL de archivo)
                                </label>
                                <input type="url" 
                                       name="video" 
                                       id="video" 
                                       ...
                                       placeholder="Ej: https://www.youtube.com/embed/VIDEO_ID o URL de archivo">
                                @error('video')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                    ...
                    <div class="bg-gray-50 rounded-lg p-6">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <p class="mt-1 text-sm text-gray-500">Imagen principal del producto (máx. 2MB)</p>
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-sm text-gray-500">Imagen mostrando el producto en uso por un modelo (máx. 2MB)</p>
                                @error('model_image')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-sm text-gray-500">Puedes seleccionar múltiples imágenes (máx. 2MB cada una)</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <select name="gender" 
                                    ...
                                    <option value="niño" {{ old('gender') == 'niño' ? 'selected' : '' }}>Niño</option>
                                </select>
                                @error('gender')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <select name="type" 
                                        ...
                                        required>
                                    <option value="oftalmico" {{ old('type') == 'oftalmico' ? 'selected' : '' }}>Oftálmico</option>
                                    <option value="sol" {{ old('type') == 'sol' ? 'selected' : '' }}>Sol</option>
        ...
        reader.onload = function(e) {
            ...
            if (!preview) {
                ...
                preview.innerHTML = `
                    ...
                    <p class="text-sm text-gray-500 mt-1">Vista previa</p>
                `;
